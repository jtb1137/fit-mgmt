...
ActiveRecord::Schema.define(version: 20180216143333) do
  ...
  create_table "programs", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["clients_id"], name: "index_programs_on_clients_id"
    t.index ["trainers_id"], name: "index_programs_on_trainers_id"
  end
